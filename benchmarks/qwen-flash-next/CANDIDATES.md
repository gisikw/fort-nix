...
| EngramHalo.cpp | current pin `15176583b358d791b7a73f210ef4ab9e167cfba7`; old measured pin `4ff3affc2ac5861f7dda42bcf5ff653c776b816f` | source-compatible, load unproved; published runs use other quant/config | ROCm 10 candidate/package contract and source check added; not on-box tested | ROCm/HIP-only. Published gains use IQ3_XXS/IQ4_XS, q8 KV, MTP and resident/SSD engram modes, not this UD-Q3_K_XL baseline. Live sources prescribe ROCm 7.x, not 10, and do not substantiate the separately quoted 1086–1204 pp t/s. See `ENGRAMHALO-ROCM10-QUALIFICATION.md`. |
