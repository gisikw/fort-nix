...
| pwilkin Strix Halo | ROCr/HIP `7dda3ac6cfe6bbe0b7f08c23a67cfa118d8641a1`; llama.cpp `f5daaa3cfa6358e5dd398911ec741813745a5440` | exact published nine-shard IQ4_NL-PROJFIX + MTP | ROCm 10 build/provenance/hash gates passed; exact model load blocked by current memory partition | This is the recovered source of the 1086–1204 pp t/s claim. On lordhenry, its single 67,591.54 MiB weight allocation exceeds both the 64 GiB VRAM carveout and 62.44 GiB system RAM; direct allocation and corrected managed allocation both failed safely before a benchmark iteration. See `PWILKIN-ROCM10-LIVE-2026-09-13.md`. |
