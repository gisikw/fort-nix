...
# Read files on the remote system
fort q read-file '{"path": "/nix/store/xyz-nginx.conf"}'
fort q read-file '{"path": "/var/log/nginx", "limit": 20}'
fort q read-file '{"path": "/some/file.log", "offset": 100, "limit": 50}'
